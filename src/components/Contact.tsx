...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-24 md:py-32 bg-gradient-to-br from-gray-50 to-white overflow-hidden relative">
      {/* Elementos decorativos de fondo */}
      <div className="absolute left-0 top-0 w-full h-full overflow-hidden z-0">
        <div className="absolute -left-64 bottom-0 w-96 h-96 bg-blue-50 rounded-full opacity-50"></div>
        <div className="absolute right-0 top-1/4 w-64 h-64 bg-blue-100/30 rounded-full"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 max-w-xl">
            Hablemos de tu <span className="relative inline-block">proyecto<span className="absolute -bottom-2 left-0 w-full h-1 bg-blue-500"></span></span>
          </h2>
          ...
          >
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 mb-8">
              <h3 className="text-2xl font-semibold text-gray-900 mb-6 flex items-center">
                <span className="h-1 w-6 bg-blue-400 mr-3"></span>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-gray-600">info@yelloomstudio.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-gray-600">Buenos Aires, Argentina</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              <h3 className="text-lg font-medium text-gray-900 mb-4 flex items-center">
                <span className="h-px w-4 bg-blue-400 mr-2"></span>
                Síguenos
              </h3>
              <div className="flex space-x-4">
                <a href="#" className="p-2 bg-gray-50 rounded-full text-gray-600 hover:text-blue-500 hover:bg-blue-50 transition-colors duration-300">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <button
                      ...
                      className={`w-full flex justify-center items-center py-3 px-6 rounded-lg text-white bg-blue-600 hover:bg-blue-700 transition-colors duration-300 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
                    >
                      {isSubmitting ? (
                        <>
